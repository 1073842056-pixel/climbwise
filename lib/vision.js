...
{
  "holds": [{"type":"hand"|"foot", "x":0.0-1.0, "y":0.0-1.0, "size":"large"|"medium"|"small", "gripType":"...", "footType":"...", "description":"..."}],
  "beta": [
    {"step":1, "handPosition":"...", "footPosition":"...", "hipAction":"...", "bodyPosture":"...", "keyPoint":"..."}
  ],
  "frames": [
  ...
  "overallScore": 7.8,
  "estimatedAttempts": "3-4次",
  "difficultyReason": "第二步的reach需要用户臂展的90%以上，且需要在动态中保持核心稳定"
}`
      }
    ],
    reply_constraints: {
