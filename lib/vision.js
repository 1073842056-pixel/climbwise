...
const FALLBACK_ANALYSIS = {
  holds: [
    { type: 'hand', x: 0.72, y: 0.15, size: 'large', description: '右上角大手点 - Open Crimp 开口握，力量型动作', moveType: 'OpenCrimp' },
    { type: 'hand', x: 0.35, y: 0.38, size: 'medium', description: '左侧小手点 - Crimp 扣握，需要较强指尖力量', moveType: 'Crimp' },
    { type: 'foot', x: 0.28, y: 0.55, size: 'large', description: '左下脚点 - Edging 内边缘踩法', moveType: 'Edging' },
    { type: 'hand', x: 0.65, y: 0.55, size: 'small', description: '中间脚点 - Sloper 斜面，需要髋部贴近岩壁', moveType: 'Sloper' },
    { type: 'foot', x: 0.50, y: 0.70, size: 'medium', description: '中间脚点 - 换脚点，Drop Knee 准备', moveType: 'DropKnee' },
    { type: 'hand', x: 0.45, y: 0.85, size: 'large', description: '顶部大手点 - Pinch 捏握，稳定顶端', moveType: 'Pinch' },
  ],
  beta: [
    { step: 1, description: '起始姿势：双脚踩左下脚点，右手以 Open Crimp 抓右上大手点，核心收紧', keyPoint: '三点固定，重心下沉，脚推墙而非手臂拉', moveType: 'OpenCrimp', style: 'strength' },
    { step: 2, description: '左手抓左侧小手点，身体右移，左脚微抬准备换脚', keyPoint: 'Campusing 基础，注意肩部不要锁死', moveType: 'Crimp', style: 'technique' },
    { step: 3, description: '右脚移动到中间脚点（Drop Knee 姿势），左脚内侧边缘踩稳', keyPoint: '膝盖向内向下旋转，髋部贴近岩壁，这是关键休息点', moveType: 'DropKnee', style: 'flexibility' },
    { step: 4, description: '右手抓中间 Sloper，身体外倾靠摩擦力，左手辅助平衡', keyPoint: 'Hip Hinge 髋铰链，膝盖离墙越远摩擦力越大', moveType: 'Sloper', style: 'flexibility' },
    { step: 5, description: '双手抓顶部 Pinch，双脚发力，身体向上顶，完成！', keyPoint: '顶峰冲拳 🎉 爆发庆祝', moveType: 'Pinch', style: 'power' },
  ],
  frames: [
...
{
  "holds": [
    {"type":"hand"|"foot", "x":0.0-1.0, "y":0.0-1.0, "size":"large"|"medium"|"small", "description":"描述（说明手点类型如OpenCrimp/Crimp/Pinch/Sloper，或脚点类型如Edging/Smear）", "moveType":"动作类型名"}
  ],
  "beta": [
    {"step":1, "description":"动作描述（含具体抓握方式和身体姿态）", "keyPoint":"核心要点（含具体发力原理）", "moveType":"该步使用的动作类型", "style":"strength|technique|flexibility|dynamic"}
  ],
  "frames": [
  ...
  "difficultyPoints": [{"step":1,"description":"难点描述"}],
  "suggestions": ["针对用户弱点的具体训练建议"],
  "betaPattern": "toe-to-hip|drop-knee-sloper|heel-toe-rockover 等组合名称"
}`
      }
    ],
    reply_constraints: {
